...
public class T2_LinkTextPractice {
    public static void main(String[] args) throws InterruptedException {
        ...
        //3- Click to A/B Testing from top of the list. We use locator - linkText()
        WebElement abTestLink = driver.findElement(By.linkText("A/B Testing"));

        abTestLink.click();

        //or we can use locator - partialLinkText()
     // WebElement abTestLink = driver.findElement(By.partialLinkText("A/B"));
        ...
        if(actualTitle.equals(expectedTitle)){
            System.out.println("Practice page title verification is passed");
        }else{
            System.out.println("Practice page title verification is failed");
        }
